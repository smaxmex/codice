...
id.n = "Asc": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "Fine": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "MettiS": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "MettiD": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "Mez": id.subfunc = 2: id.callname = "sub_stub": id.musthave = "$": regid
clearid
id.n = "Stampa": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "Opzione": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "Scambia": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "Sistema": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "Scrivi": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "Leggi": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "Chiudi": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "Reset": id.subfunc = 2: id.callname = "sub_stub": regid
clearid
id.n = "Lettura": id.subfunc = 2: id.callname = "sub_stub": regid
...
clearid
id.n = "Attributi": id.subfunc = 1: id.callname = "func_stub": id.args = 2: id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER): id.ret = LONGTYPE - ISPOINTER: regid
clearid
...
id.specialformat = "[{Acceso|Spento}][,{_Stretch|_Smooth}]"
id.hr_syntax = "_RESIZE [{ACCESO|SPENTO}][, {_STRETCH|_SMOOTH}]"
regid
...
id.args = 1
id.arg = MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "{Acceso|Spento}"
id.hr_syntax = "_CONSOLE {Acceso|Spento}"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "{Acceso|Spento}"
id.hr_syntax = "_CONTROLCHR {Acceso|Spento}"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "{Acceso|Spento}"
id.hr_syntax = "_BLINK {Acceso|Spento}"
regid
...
clearid
id.n = "Manopola": id.Dependency=DEPENDENCY_DEVICEINPUT
id.subfunc = 1
...
id.ret = LONGTYPE - ISPOINTER
id.specialformat = "?[,?]"
id.hr_syntax = "MANOPOLA(direction%) or MANOPOLA(direction%, axis_number%)"
regid

clearid
id.n = "Pulsanti": id.Dependency=DEPENDENCY_DEVICEINPUT
id.subfunc = 1
...
id.ret = LONGTYPE - ISPOINTER
id.specialformat = "?[,?]"
id.hr_syntax = "PULSANTI(button_function%) or MANOPOLA(button_function%, device_number%)"
regid
...
id.specialformat = "[(?[,?])]{Acceso|Spento|Stop}"
...
id.hr_syntax = "PULSANTI(button%) {Acceso|Spento|Stop}"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "(?){Acceso|Spento|Stop}"
id.hr_syntax = "TASTI(number) {Acceso|Spento|Stop}"
regid
...
id.specialformat = "[#]?[,[?][{A}?]]"
id.hr_syntax = "BLOCCA #fileNumber%, record& or BLOCCA #fileNumber% firstRecord& A lastRecord&"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(INTEGER64TYPE - ISPOINTER) + MKL$(INTEGER64TYPE - ISPOINTER)
id.specialformat = "[#]?[,[?][{To}?]]"
id.hr_syntax = "SBLOCCA #fileNumber%, record& or SBLOCCA #fileNumber% firstRecord& A lastRecord&"
regid
...
id.args = 2
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "[(?)]{Acceso|Spento|Stop|Libera}"
id.hr_syntax = "TEMPO[(number%)] {Acceso|Spento|Stop|Libera}"
regid
...
id.args = 1
id.arg = MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "[{_Off|_Stretch|_SquarePixels|Spento}][,{_Smooth}]"
id.hr_syntax = "_FULLSCREEN [{_Off|_Stretch|_SquarePixels|Spento}][,{_Smooth}]"
regid
...
id.args = 2
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "[{_Stretch|_SquarePixels|_Off|_All|Spento}][,{_Smooth|_Off|_All|Spento}]"
id.hr_syntax = "_ALLOWFULLSCREEN [{_Stretch|_SquarePixels|_Off|_All|Spento}][,{_Smooth|_Off|_All|Spento}]"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER)
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "AMBIENTE$(listIndex%) or AMBIENTE$(systemID$)"
regid
...
id.args = 1
id.arg = MKL$(STRINGTYPE - ISPOINTER)
id.hr_syntax = "AMBIENTE stringExpression$"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "[{Acceso|Spento}]"
id.hr_syntax = "_ACCEPTFILEDROP [{Acceso|Spento}]"
regid
...
id.args = 2
id.arg = MKL$(LONGTYPE - ISPOINTER)+MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "{Acceso|Spento|Blocca|_Clear}[,?]"
id.hr_syntax = "_DEPTHBUFFER {Acceso|Spento|Blocca|_Clear}[,handle&]"
regid
...
id.args = 1
id.arg = MKL$(STRINGTYPE - ISPOINTER)
id.hr_syntax = "DISEGNA drawString$"
regid

clearid
id.n = "Suona": id.Dependency = DEPENDENCY_AUDIO_OUT
id.subfunc = 2
id.callname = "sub_play"
id.args = 1
id.arg = MKL$(STRINGTYPE - ISPOINTER)
id.hr_syntax = "SUONA commandString$"
regid
...
id.specialformat = "?{Come}?"
id.hr_syntax = "RINOMINA oldFileOrFolderName$ COME newFileOrFolderName$"
regid
...
id.hr_syntax = "ESEGUI [_DONTWAIT] [_HIDE] commandToRun$"
regid
...
id.arg = MKL$(STRINGTYPE - ISPOINTER)
id.ret = INTEGER64TYPE - ISPOINTER
id.hr_syntax = "ESEGUI(commandToRun$)"
regid
...
id.specialformat = "?[,?]"
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "LETTURA$(numberOfBytes%[, fileOrPortNumber])"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "[#]?,?"
id.hr_syntax = "CERCA filenumber&, position"
regid
...
id.specialformat = "?,?[,?]"
id.ret = ULONGTYPE - ISPOINTER
id.hr_syntax = "SCHERMO(x, y[, colorflag%])"
regid
...
id.ret = SINGLETYPE - ISPOINTER
id.hr_syntax = "Piano(coordinate, function_number%)"
regid
...
id.specialformat = "?[,?]"
id.ret = DOUBLETYPE - ISPOINTER
id.hr_syntax = "PUNTO(x, y) or PUNTO({0|1|2|3})"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "?,?[,?]"
id.hr_syntax = "ASPETTA port%, andMask%[, xorMask%]"
regid
...
id.specialformat = "?,[?]"
id.ret = LONGTYPE - ISPOINTER
id.hr_syntax = "LIMITEI(arrayName[, dimension%])"
regid
...
id.specialformat = "?,[?]"
id.ret = LONGTYPE - ISPOINTER
id.hr_syntax = "LIMITES(arrayName[, dimension%])"
regid
...
id.arg = MKL$(-1)
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "ESA$(decimalNumber)"
regid
...
id.arg = MKL$(-1)
id.ret = -1
id.hr_syntax = "ESP(numericExpression)"
regid
...
id.specialformat = "[{Passo}](?,?)[,[?][,[?][,?]]]"
'TINGI [PASSO] (x!,y!)[,[paint] [,[bordercolor&] [,background$]]]
id.hr_syntax = "TINGI [PASSO] (x!, y!)[,[fillColor&] [,[bordercolor&] [,pattern$]]]"
regid
...
id.hr_syntax = "CERCHIO [PASSO] (x!, y!), radius![, [color&] [, [start!] [, [end!] [, aspect!]]]]"
regid
...
id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "?[,?]"
id.hr_syntax = "CARICA fileName$, VARPTR(imageArray%(index))"
regid
...
id.hr_syntax = "SALVA saveFile$, VARPTR(array(index)), fileSize&"
regid
...
id.specialformat = "[{Passo}](?,?)-[{Passo}](?,?),?[,?]"
id.secondargmustbe = "PASSO"
id.hr_syntax = "PRENDI [PASSO] (column1, row1)-[PASSO](column2, row2), array([index])[, offscreenColor]"
regid
...
id.hr_syntax = "PRENDI #fileNumber&, [position][, targetVariable|targetArray()}]"
regid
...
'id.specialformat = "[#]?,[?],?" 'non field complient definition
id.specialformat = "[#]?[,[?][,?]]" 'field complient definition
id.hr_syntax = "METTI #filenumber&, [position][, {holdingvariable|holdingarray()}]"
regid
...
id.specialformat = "?[{Per Casuale|Per Binario|Per Lettura|Per Scrittura|Per Aggiunta}][{Accesso Leggi Scrivi|Accesso Leggi|Accesso Scrivi}][{Condiviso|Blocca Leggi Scrivi|Blocca Leggi|Blocca Scrivi}]{Come}[#]?[{Lun =}?]"
id.hr_syntax = "APRI fileName$ [PER mode] [ACCESSO|BLOCCA|CONDIVISO [{LEGGI|SCRIVI}] COME [#]fileNumber& [LUN = recordLength]"
regid
...
id.specialformat = "?,[#]?,?[,?]"
id.hr_syntax = "APRI modeLetter$, [#]fileNumber&, fileName$[, recordLength]"
regid
...
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "CRI$(integerVariableOrLiteral%)"
regid
clearid
id.n = "CrL"
id.musthave = "$"
...
id.arg = MKL$(LONGTYPE - ISPOINTER)
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "CRL$(longVariableOrLiteral&)"
regid
clearid
id.n = "CrS"
id.musthave = "$"
...
id.arg = MKL$(SINGLETYPE - ISPOINTER)
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "CRS$(singlePrecisionVariableOrLiteral!)"
regid
clearid
id.n = "CrD"
id.musthave = "$"
...
id.arg = MKL$(DOUBLETYPE - ISPOINTER)
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "CRD$(doublePrecisionVariableOrLiteral#)"
regid
clearid
id.n = qb64prefix$ + "Cr"
id.musthave = "$"
...
id.arg = MKL$(-1) + MKL$(-1)
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "_CR$(numericalType, numericalValue)"
regid
...
id.arg = MKL$(STRINGTYPE - ISPOINTER)
id.ret = SINGLETYPE - ISPOINTER
id.hr_syntax = "CVSFBM(stringData$)"
regid
clearid
id.n = "CVDFBM"
id.subfunc = 1
...
id.arg = MKL$(STRINGTYPE - ISPOINTER)
id.ret = DOUBLETYPE - ISPOINTER
id.hr_syntax = "CVDFBM(stringData$)"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "STRINGA$(count&, {character$ | ASCIIcode%})"
regid
...
id.ret = STRINGTYPE - ISPOINTER
id.specialformat = "?,?,[?]" 'checked!
id.hr_syntax = "MEZ$(stringValue$, startPosition%[, bytes%])"
regid
...
id.specialformat = "[?][,?]"
id.hr_syntax = "PSC [method%] [, bgColor&]"
regid
...
id.args = 2
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.hr_syntax = "PONI segment_offset, offset_value"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER)
id.ret = LONGTYPE - ISPOINTER
id.hr_syntax = "VEDI(segment_offset)"
regid
...
id.hr_syntax = "ASS(numericalValue)"
regid
...
id.args = 1
id.arg = MKL$(ULONGTYPE - ISPOINTER)
id.hr_syntax = "ERRORE codeNumber%"
regid
...
id.specialformat = "[[{Passo}](?,?)]-[{Passo}](?,?)[,[?][,[{R|RP}][,?]]]"
id.hr_syntax = "LINEA [PASSO] [(column1, row1)]-[PASSO] (column2, row2), color[, [{R|RP}], style%]"
regid

clearid
id.n = "Suono": id.Dependency = DEPENDENCY_AUDIO_OUT
id.subfunc = 2
id.callname = "sub_sound"
id.args = 2
id.arg = MKL$(DOUBLETYPE - ISPOINTER) + MKL$(DOUBLETYPE - ISPOINTER)
id.hr_syntax = "SUONO frequency, duration"
regid

clearid
id.n = "Bip": id.Dependency = DEPENDENCY_AUDIO_OUT
id.subfunc = 2
...
id.args = 1
id.arg = MKL$(DOUBLETYPE - ISPOINTER)
id.specialformat = "[[{Usando}]?]" 'checked!
id.hr_syntax = "CASUALIZZA [USANDO] {seednumber|TIMER}"
regid
...
id.args = 2
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.hr_syntax = "SCR registerAddress%, value%"
regid
...
id.args = 2
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.hr_syntax = "COPIAP sourcePage%, destinationPage%"
regid
...
id.specialformat = "[[{Schermo}](?,?)-(?,?)[,[?][,?]]]"
id.secondargcantbe = "Stampa"
id.hr_syntax = "VISTA [SCHERMO] (column1, row1)-(column2, row2)[, color][, border]"
regid
...
id.args = 2
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "{Stampa}[?{A}?]" 'new!
id.secondargmustbe = "Stampa"
id.hr_syntax = "VISTA STAMPA [topRow% A bottomRow%]"
regid
...
id.specialformat = "[[{Schermo}](?,?)-(?,?)]"
id.hr_syntax = "FINESTRA [[SCHERMO] (x1!, y1!) - (x2!, y2!)]"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "[?][,[?][,[?][,[?][,?]]]]"
id.hr_syntax = "CURSORE [row%][, column%] [, cursor%][, cursorStart%, cursorStop%]"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "[?][,[?][,?]]"
id.hr_syntax = "COLORE [foreground&][, background&]"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "[?,?]"
id.hr_syntax = "TAVOLOZZA [attribute%, red% + (green% * 256) + (blue% * 65536)] or TAVOLOZZA [existingAttribute%, newAttribute%]"
regid
...
id.args = 5
id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "[{#|LStampa}][?][,[?][,[?][,[?]]]]" 'new!
'id.specialformat = "[{#|LSTAMPA}][?][,?]" 'new!
id.hr_syntax = "MISURE [columns%][, rows%] or MISURE {file_number|device}, columnwidth%"
regid
...
id.hr_syntax = "SCHERMO {mode%|imagehandle&} [, , active_page, visual_page]"
regid
...
id.specialformat = "[{Passo}](?,?)[,?]"
id.hr_syntax = "PIXEL [PASSO](column%, row%)[, colorAttribute]"
regid
...
id.arg = MKL$(FLOATTYPE - ISPOINTER) + MKL$(FLOATTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.specialformat = "[{Step}](?,?)[,?]"
id.hr_syntax = "CPIXEL [PASSO](column%, row%)[, colorAttribute]"
regid
...
id.ret = LONGTYPE - ISPOINTER
id.hr_syntax = "LUN(literalTextOrVariable$)"
regid
...
id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "SINISTRA$(stringValue$, numberOfCharacters%)"
regid
...
id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "DESTRA$(stringValue$, numberOfCharacters%)"
regid
...
id.arg = MKL$(STRINGTYPE - ISPOINTER)
id.ret = STRINGTYPE - ISPOINTER
id.hr_syntax = "TOGLID$(text$)"
regid

clearid
id.n = qb64prefix$ + "Togli"
id.musthave = "$"
id.subfunc = 1
...
id.args = 1
id.arg = MKL$(STRINGTYPE - ISPOINTER)
id.hr_syntax = "STAMPA [expression] [{;|,] [expression...]"
regid

clearid
id.n = "LStampa": id.Dependency = DEPENDENCY_PRINTER
id.subfunc = 2
id.callname = "qbs_lprint" 'not called directly
id.args = 1
id.arg = MKL$(STRINGTYPE - ISPOINTER)
id.hr_syntax = "LSTAMPA [expression] [{;|,}]"
regid
...
id.arg = MKL$(LONGTYPE - ISPOINTER)
id.args = 1
id.specialformat = "{Acceso|Spento|_Toggle}"
id.hr_syntax = "_CAPSLOCK {Acceso|Spento|_Toggle}"
regid
...
id.args = 1
id.specialformat = "{Acceso|Spento|_Toggle}"
id.hr_syntax = "_SCROLLLOCK {Acceso|Spento|_Toggle}"
regid
...
id.args = 1
id.specialformat = "{Acceso|Spento|_Toggle}"
id.hr_syntax = "_NUMLOCK {Acceso|Spento|_Toggle}"
regid
